---
title: "[tab] Table p.18 — Table 16 (Appendix B, MMLU): Detailed 5-shot results per subject/domain on the MMLU test sets, comparing GPT-3, Gopher, Chinchilla, LLaMA (7B/13B/33B/65B), and LLaMA-I (65B). Includes 57 individual subject rows plus 4 category-average rows (Humanities, STEM, Social Science, Others) and an overall 'All' row. — touvron-2023-llama-open-efficient"
...
row_count: 62
is_snapshot: false
db_table: tab_touvron_2023_llama_open_efficient_t16
extraction_sha: 2e663675ae36ad12adb2f5a05281bac2747ecf8d23d92bedd9f937a89fee7136
extraction_method: multimodal-sonnet
source_pages: ["18"]
numeric_review_done: 2026-08-01T07:26:25Z
verdict: ok
---

Extracted from [[touvron-2023-llama-open-efficient]] (vault:20260728-230740-local-touvron-2023-llama.pdf.extracted.md), source pages [18], original: vault/touvron-2023-llama.pdf. Numeric values are literal transcriptions — do not derive or unit-convert when citing this page.

> **The paper disagrees with itself here.** Chinchilla's MMLU average is
> **67.6** in this table's `All` row (p.18, Table 16) and **67.5** in
> [[tab-touvron-2023-llama-open-efficient-t9]] (p.7, Table 9). Both
